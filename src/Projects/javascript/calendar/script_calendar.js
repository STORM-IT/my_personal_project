...
// export default function Add__calendar_program() {
//     //debugger
...
var container_calendar;
var text_box;
var number=0;

export const Add__calendar_program=()=> {
    container_calendar= document.getElementById('container-calendar');
