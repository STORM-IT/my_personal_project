...
export const sort_lineCode = () => {
    return (dispatch, getState) => {
        ...
        state_project.PROJECT = state_project.PROJECT.sort(function (a, b) { return b.line_code - a.line_code });
...
export const sort_date = () => {
    return (dispatch, getState) => {
        const state_project = { ...getState().projects };
        state_project.PROJECT = state_project.PROJECT.sort(function (a, b) { return b.create.replace('/', '') - a.create.replace('/', '') });
...
export const sort_chalenged = () => {
    return (dispatch, getState) => {
        const state_project = { ...getState().projects };
        state_project.PROJECT = state_project.PROJECT.sort(function (a, b) { return convert_mood(b.mood) - convert_mood(a.mood) });
