...
export const scroll_footer = (Scroll,innerWidth)=>{
    ...
    if (main) {
        ...
        if ( Scroll >= 4550 & innerWidth <=375 || Scroll >= 4580 && innerWidth >=376 & innerWidth <=490 || Scroll >= 4670 && innerWidth >=491 & innerWidth <=600 || Scroll >= 5210 && innerWidth >=601 & innerWidth <=768 || Scroll >= 5330 && innerWidth >=769 & innerWidth <=1000  || Scroll >= 5550 & innerWidth >=1001) {
